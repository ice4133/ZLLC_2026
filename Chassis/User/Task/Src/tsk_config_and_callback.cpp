...
void Chassis_Device_CAN3_Callback(Struct_CAN_Rx_Buffer *CAN_RxMessage){
    switch (CAN_RxMessage->Header.Identifier)
    {
        case(0xD1):
        {
            chariot.Chassis.Motor_Steer[0].CAN_MA_RxCpltCallback(CAN_RxMessage->Data);
        }
        break;
        case(0xD2):
        {
            chariot.Chassis.Motor_Steer[1].CAN_MA_RxCpltCallback(CAN_RxMessage->Data);
        }
        break;
        case(0xD3):
        {
            chariot.Chassis.Motor_Steer[2].CAN_MA_RxCpltCallback(CAN_RxMessage->Data);
        }
        break;
        case(0xD4):
        {
            chariot.Chassis.Motor_Steer[3].CAN_MA_RxCpltCallback(CAN_RxMessage->Data);
        }        
    }
}
#endif
